...
public class miningLevel_constants {
	...
	public static var heightLevels = {
		...
		<block:thermal:nickel_ore> : {"min": 1, "max" : 120},
	...
	public static var spreadLevels = {
		...
		<block:thermal:apatite_ore> : {"base" : 48, "spread" : 24},
		<block:thermal:cinnabar_ore> : {"base" : 16, "spread" : 16},
		<block:thermal:niter_ore> : {"base" : 40, "spread" : 12},
		<block:thermal:sulfur_ore> : {"base" : 24, "spread" : 12},
		<block:thermal:copper_ore> : {"base" : 40, "spread" : 80},
